...
class HummingbotApplication(*commands):
    ...
    def _send_image(self, image: str):
        try:
            ...
            self._notify(f'Error opening {image}')
            return
            ...
            if self.placeholder_mode:
                ...
                if shortcuts is not None:
                    ...
                    for shortcut in shortcuts:
                        if command_split[0] == shortcut['command']:
                            is_shortcut = True
                    ...
                    # didn't find variant with correct number of arguments
                    if is_shortcut and not handled:
