...
class MarketTradingPairTuple(NamedTuple):
    ...
    def get_volume_for_price(self, is_buy: bool, price: Decimal) -> ClientOrderBookQueryResult:
        return self.market.get_volume_for_price(self.trading_pair, is_buy, price)
