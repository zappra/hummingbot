...
from hummingbot.script.script_interface import StrategyParameter, PMMParameters, OnTick, OnStatus, OnRefresh, OnCommand, CallNotify, CallSendImage, CallLog, CallStop, CallForceRefresh
